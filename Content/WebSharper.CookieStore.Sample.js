...
{
 "use strict";
 var WebSharper,CookieStore,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,TemplateHole,Var,Handler,Unchecked,WebSharper$CookieStore$Sample_Templates,TemplateHoleModule,Text,TextView,SC$1,System,Guid,EventQ,JavaScript,Pervasives,Concurrency,Promise,EventTarget,Client$1,Templates,Doc,Collections,Dictionary,Node,Object,Var$1,JS,AsyncBody,CT,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,ConcreteVar,Snap,Scheduler,Error,NonStandardPromiseRejectionException,SC$2,DictionaryUtil,Enumerator,T,WindowOrWorkerGlobalScope,SC$3,Docs,DocElemNode,CharacterData,Abbrev,Fresh,OperationCanceledException,CancellationTokenSource,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$4,HashSetUtil,SC$5,SC$6,SC$7,AppendList,DynamicAttrNode,KeyNotFoundException,SC$8,Easing,HashSet$1,BindVar,String,CheckedInput,DomNodes,Char,DateUtil,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,console,Promise$1,Date,Runtime$1,Math;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 CookieStore=WebSharper.CookieStore=WebSharper.CookieStore||{};
 Sample=CookieStore.Sample=CookieStore.Sample||{};
 ...
 WebSharper$CookieStore$Sample_Templates=Global.WebSharper$CookieStore$Sample_Templates=Global.WebSharper$CookieStore$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_CookieStore_Sample$Client=Global.StartupCode$WebSharper_CookieStore_Sample$Client||{};
 ...
 {
  var _,b,t,t$1,t$2,_this,p,i;
  Client.cookieChanges();
  _=(b=(t=(t$1=(t$2=(_this=new ProviderBuilder.New$1(),(_this.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this)),(t$2.h.push(Handler.EventQ2(t$2.k,"getcookie",function()
  {
   return t$2.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.getCookie()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t$2)),(t$1.h.push(Handler.EventQ2(t$1.k,"setcookie",function()
  {
   return t$1.i;
  },function()
  {
   ...
   Concurrency.Start((_$1=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind(Promise.AsAsync(Client.setCookie()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"deletecookie",function()
  {
   return t.i;
  },function()
  {
   ...
   Concurrency.Start((_$1=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind(Promise.AsAsync(Client.deleteCookie()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$CookieStore$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",_);
 };
 Client.cookieChanges=function()
 {
  Client.cookieStore().addEventListener("change",function(event)
  {
   function $1(s)
   {
    console.log(s);
   }
   return $1("Cookie Changed: "+Global.String(event));
  });
 };
 ...
 Client.getCookie=function()
 {
  ...
  function f()
  {
   return Client.cookieStore().get("username").then(function(a)
   {
    return a==null?(Client.statusMessage().Set("No cookie found!"),Promise$1.resolve(null)):(Client.statusMessage().Set("Cookie Found: "+Global.String(a.name)+"="+Global.String(a.value)),Promise$1.resolve(null));
   });
  }
  _=null;
 ...
 Client.setCookie=function()
 {
  var _;
  function f()
  {
   var r;
   return Client.cookieStore().set("username","JohnDoe",(r={},r.expires=Date.now()+86400*1000,r)).then(function()
   {
    Client.statusMessage().Set("Cookie Set: username=JohnDoe");
 ...
 Client.deleteCookie=function()
 {
  var _;
  function f()
  {
   return(Client.cookieStore())["delete"]("username").then(function()
   {
    Client.statusMessage().Set("Cookie Deleted!");
    return Promise$1.resolve(null);
   });
  }
  _=null;
 ...
 Client.cookieStore=function()
 {
  SC$1.$cctor();
  return SC$1.cookieStore;
 };
 ...
 WebSharper$CookieStore$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.statusMessage=Var$1.Create$1("No cookie set.");
  SC$1.cookieStore=self.cookieStore;
 };
